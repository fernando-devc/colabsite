...
const Star = ({ size }: any) => {
    ...
    return (
        <svg viewBox="0 0 28 21" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className={(`${animate ? 'animate-ping' : ' animate-pulse '} `) + ' text-green-200 rounded-full absolute  '}
